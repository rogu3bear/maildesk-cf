...
for file in AGENTS.md README.md .env.example package.json tsconfig.json wrangler.toml deploy/mail-router/wrangler.toml deploy/mail-outbound/wrangler.toml deploy/routing-health/wrangler.toml scripts/build-router-wasm.ts scripts/preflight.ts scripts/check-cfctl-provisioning.ts scripts/check-relay-topology.ts scripts/wrangler-config.ts scripts/check-maildesk-closeout.ts scripts/collect-live-evidence.ts scripts/plan-mail-proofs.ts scripts/receipt-maildesk.ts scripts/refresh-sender-domain-ack-manifest.ts scripts/apply-sender-domain-ack-manifest.ts scripts/send-mail-probes.ts scripts/verify-maildesk.ts workers/shared/router.ts docs/ARTIFACTS-POLICY.md docs/SCRIPT-OWNERSHIP.md docs/roadmap.md docs/architecture/adr/0001-rust-router-worker-authority.md docs/architecture/template-standard.md docs/architecture/rust-router-contract.md docs/architecture/runtime-contract.md docs/architecture/outbound-identity.md docs/operations/cfctl-contract.md docs/operations/deliverability.md docs/operations/horizontal-verifier.md docs/operations/production-rollout.md ops/cfctl/maildesk-cf.surface.md ops/cfctl/maildesk-cf.desired-state.schema.json config/policy.example.json config/desired-state.example.json; do
