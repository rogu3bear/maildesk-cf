...
await writeFile(shimPath, [
  ...
  'import { isAccessProtectedPath, verifiedAccessRequest } from "../workers/ui/access.ts";',
  "",
  ...
  '    if (isAccessProtectedPath(url.pathname, this.env.MAILDESK_UI_ACCESS_SCOPE) && this.env.MAILDESK_UI_AUTH_MODE === "access") {',
