...
replace_in_file "${ROOT_DIR}/deploy/mail-router/wrangler.toml"
replace_in_file "${ROOT_DIR}/deploy/ui/wrangler.toml"
replace_in_file "${ROOT_DIR}/deploy/mail-outbound/wrangler.toml"
replace_in_file "${ROOT_DIR}/deploy/routing-health/wrangler.toml"
...
echo "Next: review the legacy web-desk configs and the three deploy/* relay configs, then provision resources with cfctl."
